...
?>
    ...
    <head>
      ...
      <style>
        ...
        .socials-header {
          margin-bottom: 10px;
          /* Add margin to create space between the header and icons */
        }
        ...
        .social {
          ...
          margin-bottom: 10px;
          /* Add margin to create space between each social icon and name */
        }
        ...
        .social a:focus {
          color: #800080;
          /* Change color to purple/blue on hover or focus */
        }
    ...
    <body>
      ...
      <main>
        <h2 class="payment-method"> Paying for your trip</h2>
        <h3 class="app-payment"> App Payment</h3>
        <h4 class="information-app">Vroom Car Rental now accepts Apple Pay on mobile devices in all locations. In Nepal, we are pleased to
          offer additional payment options including eSewa, Khalti, and PayPal.
          When using Apple Pay, eSewa, Khalti, or PayPal, please ensure you have an additional form of payment linked to your account.
          This is necessary to cover any post-rental costs, as these digital payment apps cannot be used for such charges.</h4>

        <h5 class="method">Payment Method We Accepts</h5>
