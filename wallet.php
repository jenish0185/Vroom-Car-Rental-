...
<head>
    ...
    <style>
        ...
        .wallet-box {
            ...
            border-radius: 10px;
            /* Changed to 10px to match the double declaration */
            box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);
            width: calc(100% - 40px);
            /* Adjusted width */
            max-width: 600px;
            /* Max width */
            border: 2px solid #7B2CF8;
        ...
        label {
            color: #7B2CF8;
            /* Make label text purple */
        }

        input[type="date"] {
            color: #7B2CF8;
            /* Make input text purple */
            border: 2px solid purple;
            /* Make input border purple */
            padding: 5px;
        ...
        input[type="date"]::placeholder {
            color: #7B2CF8;
            /* Ensure placeholder text is also purple */
        }
